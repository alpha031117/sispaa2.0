...
const FloatingChatbot = () => {
    ...
    return (
        <div className='z-30'>
                    ...
                    <div className='fixed bottom-4 right-8 bg-white rounded-lg shadow-lg w-96 h-96'>
                        <div className='p-4'>
                            ...
                            <form onSubmit={handleSend} className='flex flex-row gap-12'>
                                <input type='text' className='w-full border border-gray-300 rounded-md p-2' placeholder="Ask Me Everything..." value={userInput} onChange={(e) => setUserInput(e.target.value)} />
            ...
            : (
                <button className='rounded-full p-4 fixed bottom-4 right-8 bg-accent_blue text-white' onClick={() => {setIsChatbotOpen(true)}}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-6">
